...
class QualificacaosControllerTest < ActionController::TestCase
  ...
  test "should create qualificacao" do
    assert_difference('Qualificacao.count') do
      post :create, qualificacao: { academia_id: @qualificacao.academia_id, comentario: @qualificacao.comentario, nota: @qualificacao.nota, usuario_id: @qualificacao.usuario_id }
    end
  ...
  test "should update qualificacao" do
    patch :update, id: @qualificacao, qualificacao: { academia_id: @qualificacao.academia_id, comentario: @qualificacao.comentario, nota: @qualificacao.nota, usuario_id: @qualificacao.usuario_id }
    assert_redirected_to qualificacao_path(assigns(:qualificacao))
  end
